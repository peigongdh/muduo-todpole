        ...
        namespace ws {
            ...
            */
            WsFrameType decodeFrame(const char *inbuf, int inlength, std::vector<char> *outbuf) {
                ...
                {
                    payload_length = static_cast<int>(static_cast<unsigned long long>(inp[2]) << 56) +
                                     static_cast<int>(static_cast<unsigned long long>(inp[3]) << 48) +
                                     static_cast<int>(static_cast<unsigned long long>(inp[4]) << 40) +
                                     static_cast<int>(static_cast<unsigned long long>(inp[5]) << 32) +
                                     static_cast<int>(static_cast<unsigned long long>(inp[6]) << 24) +
                                     static_cast<int>(static_cast<unsigned long long>(inp[7]) << 16) +
                                     static_cast<int>(static_cast<unsigned long long>(inp[8]) << 8) +
                                     static_cast<int>(static_cast<unsigned long long>(inp[9]) << 0);
                ...
                if (msg_opcode == 0x0)
                    return (msg_fin) ? WS_TEXT_FRAME : WS_INCOMPLETE_TEXT_FRAME; // continuation frame ?
