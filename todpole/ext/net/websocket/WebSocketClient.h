    ...
    namespace net {
        ...
        namespace ws {
            ...
            public:
                ...
                OnCloseCallback;
                typedef std::function<void (
                const TcpConnectionPtr&, const std::vector<char>& , Timestamp)>
                OnMessageCallback;
            ...
            public:
                ...
                void
                close(const TcpConnectionPtr &conn, WsCloseReason code = WS_CLOSE_NORMAL, const char *reason = NULL) {
            ...
            private:
                ...
                void
                sendData(const TcpConnectionPtr &conn, WsOpcode opcode, uint64_t message_size, Iterator message_begin,
            ...
            void WsClient::sendData(const TcpConnectionPtr &conn, WsOpcode opcode, uint64_t message_size,
                ...
                header.assign(2 + (message_size >= 126 ? 2 : 0) + (message_size >= 65536 ? 6 : 0) + (useMask_ ? 4 : 0),
                              0);
